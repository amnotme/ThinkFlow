...
export const TAGS: TagConfig[] = [
  { name: 'All', icon: '💭', colorClass: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300' },
  { name: 'Urgent', icon: '🔥', colorClass: 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400' },
  { name: 'Ideas', icon: '💡', colorClass: 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400' },
  { name: 'To Do', icon: '📌', colorClass: 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400' },
  { name: 'Questions', icon: '🤔', colorClass: 'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400' },
  { name: 'Inspiration', icon: '✨', colorClass: 'bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400' },
];

export const ICONS = {
  Pin: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m9 12 6 6"/><path d="M15 3h6v6"/><path d="M21 3 13.5 10.5"/><path d="M14.85 18 9.23 22.28a.44.44 0 0 1-.69-.45l1.41-5.14a7.1 7.1 0 0 1-3.13-3.13l-5.14 1.41a.44.44 0 0 1-.45-.69L5.51 8.67"/><path d="m12 12 4 4"/></svg>
  ),
  Edit: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 22h6-6Z"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5Z"/></svg>
  ),
  ...
  Moon: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
  ),
  ...
  Stats: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
  ),
};
